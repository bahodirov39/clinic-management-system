...
<!-- Mirrored from hencework.com/theme/jampack/classic/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Oct 2023 22:39:18 GMT -->
<head>
    <!-- Meta Tags -->
	<meta charset="UTF-8">
	...
	<!-- Daterangepicker CSS -->
    <link href="{{ asset('crm/vendors/daterangepicker/daterangepicker.css') }}" rel="stylesheet" type="text/css" />

	<!-- Data Table CSS -->
    <link href="{{ asset('crm/vendors/datatables.net-bs5/css/dataTables.bootstrap5.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('crm/vendors/datatables.net-responsive-bs5/css/responsive.bootstrap5.min.css') }}" rel="stylesheet" type="text/css" />

	<!-- CSS -->
    <link href="{{ asset('crm/dist/css/style.css') }}" rel="stylesheet" type="text/css">
...
<body>
	...
	<div class="hk-wrapper" data-layout="vertical" data-layout-style="default" data-menu="light" data-footer="simple">
			...
			<div data-simplebar class="nicescroll-bar">
				<div class="menu-content-wrap">
					...
					<div class="menu-group">
						...
						<ul class="navbar-nav flex-column">
                            <li class="nav-item @if(str_contains(url()->current(), '/services')) active @endif">
                            ...
                            <li class="nav-item @if(str_contains(url()->current(), '/dentists')) active @endif">
								<a class="nav-link" href="{{ route('dentists') }}">
									...
									<span class="nav-link-text">Dentists</span>
                                    {{-- <span class="badge badge-soft-success ms-2">2</span> --}}
								</a>
							</li>
                            <li class="nav-item @if(str_contains(url()->current(), '/items')) active @endif">
								<a class="nav-link" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#dash_chat">
									...
									<span class="nav-link-text">Invertory</span>
								</a>
								<ul id="dash_chat" class="nav flex-column collapse  nav-children">
									<li class="nav-item">
										<ul class="nav flex-column">
											<li class="nav-item">
												<a class="nav-link" href="{{ route('cat.items') }}"><span class="nav-link-text">Categories</span></a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="{{ route('items') }}"><span class="nav-link-text">Items</span></a>
											</li>
										</ul>
									</li>
								</ul>
        ...
        <!-- jQuery -->
        <script src="{{ asset('crm/vendors/jquery/dist/jquery.min.js') }}"></script>

        <!-- Bootstrap Core JS -->
        <script src="{{ asset('crm/vendors/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>

        <!-- FeatherIcons JS -->
        <script src="{{ asset('crm/dist/js/feather.min.js') }}"></script>

        <!-- Fancy Dropdown JS -->
        <script src="{{ asset('crm/dist/js/dropdown-bootstrap-extended.js') }}"></script>

        <!-- Simplebar JS -->
        <script src="{{ asset('crm/vendors/simplebar/dist/simplebar.min.js') }}"></script>

        <!-- Data Table JS -->
        <script src="{{ asset('crm/vendors/datatables.net/js/jquery.dataTables.min.js') }}"></script>
        <script src="{{ asset('crm/vendors/datatables.net-bs5/js/dataTables.bootstrap5.min.js') }}"></script>
        <script src="{{ asset('crm/vendors/datatables.net-select/js/dataTables.select.min.js') }}"></script>

        <!-- Daterangepicker JS -->
        <script src="{{ asset('crm/vendors/moment/min/moment.min.js') }}"></script>
        <script src="{{ asset('crm/vendors/daterangepicker/daterangepicker.js') }}"></script>
        <script src="{{ asset('crm/dist/js/daterangepicker-data.js') }}"></script>

        <!-- Amcharts Maps JS -->
        <script src="{{ asset('crm/vendors/%40amcharts/amcharts4/core.js') }}"></script>
        <script src="{{ asset('crm/vendors/%40amcharts/amcharts4/maps.js') }}"></script>
        <script src="{{ asset('crm/vendors/%40amcharts/amcharts4-geodata/worldLow.js') }}"></script>
        <script src="{{ asset('crm/vendors/%40amcharts/amcharts4-geodata/worldHigh.js') }}"></script>
        <script src="{{ asset('crm/vendors/%40amcharts/amcharts4/themes/animated.js') }}"></script>

        <!-- Apex JS -->
        <script src="{{ asset('crm/vendors/apexcharts/dist/apexcharts.min.js') }}"></script>

        <!-- Init JS -->
        <script src="{{ asset('crm/dist/js/init.js') }}"></script>
        <script src="{{ asset('crm/dist/js/chips-init.js') }}"></script>
        <script src="{{ asset('crm/dist/js/dashboard-data.js') }}"></script>

        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.inputmask/5.0.6/jquery.inputmask.min.js"></script>

        {{-- toastr --}}
        <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js" integrity="sha512-VEd+nq25CkR676O+pLBnDW09R7VQX9Mdiij052gVCp5yVH3jGtH70Ho/UUv4mJDsEdTvqRCFZg0NKGiojGnUCw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        @include('dynamics.toastr')
        <script>
            $('.submitBtn').click(function(e){
                e.preventDefault();
                var inputVal = $('.myInput').val();
                if(inputVal === ''){
                    $('.myInput').val('Please fill this field');
                }
            });

            $(document).ready(function(){
                $('.phone_format').inputmask("999999999999");
                $('.money_format').inputmask('numeric', {
                    alias: 'numeric',
                    groupSeparator: ' ',
                    autoGroup: true,
                    digits: 0,
    ...
    <!-- Mirrored from hencework.com/theme/jampack/classic/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Oct 2023 22:39:48 GMT -->
    </html>
