...
<!-- Mirrored from hencework.com/theme/jampack/classic/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Oct 2023 22:40:44 GMT -->
<head>
    <!-- Meta Tags -->
	<meta charset="UTF-8">
                                            ...
                                            <div class="col-xl-7 col-sm-10 mx-auto">
                                                ...
                                                <div class="row gx-3">
                                                    <div class="form-group col-lg-12">
                                                        ...
                                                        <input class="form-control" name="phone_number" placeholder="Enter phone number" value="{{ old('phone_number') }}" type="text">
                                                    </div>
                                                    <div class="form-group col-lg-12">
                                                        <div class="form-label-group">
                                                        ...
                                                        <div class="input-group password-check">
                                                            <span class="input-affix-wrapper affix-wth-text">
                                                                <input class="form-control" name="password" placeholder="Enter your password" value="{{ old('password') }}" type="password">
								...
								<footer class="container-xxl footer">
									<div class="row">
										<div class="col-xl-8 text-center">
											<p class="footer-text pb-0"><span class="copy-text">Jampack © 2023 All rights reserved.</span> <a href="#" class="" target="_blank">Privacy Policy</a><span class="footer-link-sep">|</span><a href="#" class="" target="_blank">T&C</a><span class="footer-link-sep">|</span><a href="#" class="" target="_blank">System Status</a></p>
										</div>
									</div>
								</footer>
							</div>
